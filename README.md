...
NumberAnalyzer é uma aplicação web simples que permite ao usuário inserir números separados por vírgula e obter automaticamente:
...
1. Digite números separados por vírgula.
   Exemplo:
   10,20,30,5
